            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildTextFieldNormal("Bill No", getCurrentBillNo().toString()),
                _buildTextFieldNormal("Bill Date", DateFormat('dd/MMM/yyyy').format(DateTime.now())),
...
class _ItemCardState extends State<ItemCard> {
  ...
  void initState() {
    ...
    _priceController = TextEditingController(text: item['sellPrice'].toString());
                          ...
                          Expanded(
                            ...
                            child: ElevatedButton(
                              ...
                              onPressed: () {
                                Navigator.push(
                                  context,
                                  MaterialPageRoute(builder: (context) => CheckoutPage(cart,total)),
                                );
                              },
